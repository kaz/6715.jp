...
前回はConoHaにWindowsを入れてHTTPリクエストできりたん好きなコトを喋らせるサーバができたのでした。
...
ということで、ConoHa上のWindowsServerでWin32APIを使ってVOICEROIDを操作してTwitterのTLを読み上げた音声をHLSでライブ配信できました！
