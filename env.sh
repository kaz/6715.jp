ENGINE="nextjs-blog-scaffold"

export ARTICLES_DIR="../articles"
export EXTERNAL_DIR="../articles/external"

export NEXT_PUBLIC_LANG="ja"
export NEXT_PUBLIC_BLOG_TITLE="6715.jp"
export NEXT_PUBLIC_BLOG_DESCRIPTION="sekaiのブログ"
export NEXT_PUBLIC_BLOG_URL="https://6715.jp"
...
export NEXT_PUBLIC_AUTHOR_BIO="インフラとDXが好き"
export NEXT_PUBLIC_COPYRIGHT="2016 $NEXT_PUBLIC_AUTHOR_NAME"

export NEXT_PUBLIC_GA_MEASUREMENT_ID="G-XKSQ648BQ2"
